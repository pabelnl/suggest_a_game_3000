...
def index():
    ...
    question2 = "Name a video game that you would like a recommendation:"
...
def process_form():
    ...
    return render_template("results.html", new_game_list = new_game_list,
                           new_game_images = new_game_images, 
